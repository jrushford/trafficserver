...
typedef enum {
  ...
  TS_LUA_CONFIG_HTTP_PARENT_PROXY_ENABLE_CONN_WARNING         = TS_CONFIG_HTTP_PARENT_PROXY_ENABLE_CONN_WARNING,
...
ts_lua_var_item ts_lua_http_config_vars[] = {
  ...
  TS_LUA_MAKE_VAR_ITEM(TS_LUA_CONFIG_HTTP_PARENT_PROXY_ENABLE_CONN_WARNING),
